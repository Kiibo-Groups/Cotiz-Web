...
Route::prefix(env('admin'))->namespace('Admin')->group(static function() {
    ...
    Route::middleware('admin')->group(static function () {
        ...
        */
        ...
        Route::get('/empresas/usuarios/cashback/{id}', [App\Http\Controllers\Admin\AdminController::class, 'CashbackEmpresas']);
        Route::post('/register/empresas/usuarios/cashback', [App\Http\Controllers\Admin\AdminController::class, 'CashbackEmpresasEdict'])->name('register_empresa_cashback');
