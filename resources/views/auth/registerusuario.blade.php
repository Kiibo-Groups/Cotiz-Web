<form class="text-start mb-3" method="POST" enctype="multipart/form-data" action="{{ route('register_post') }}">
    ...
    <div class="row">
        <div class="col-lg-6 form-floating mb-3">
            <input id="empresanombre" type="text" class="form-control" name="empresanombre" disabled readonly>

            <label for="numeroPlanta">Nombre Empresa </label>
        </div>
        <div class="col-lg-6 form-floating mb-3">
            <input id="signupName" type="text" class="form-control @error('name') is-invalid @enderror"
    ...
    <div class="row">
        <div class="col-lg-6 form-floating mb-3">
            <input id="fotoGafete" type="file" class="form-control" name="fotoGafete" value="{{ old('fotoGafete') }}"
    ...
    <div class="row">
        <div class="col-lg-6 form-floating mb-3">
            <input id="telefonoEmpresa" type="text" class="form-control" name="telefonoEmpresa"
                value="{{ old('telefonoEmpresa') }}" required>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 form-floating mb-3">
            <input id="direccionEmpresa" type="text" class="form-control" name="direccionEmpresa"
                value="{{ old('direccionEmpresa') }}" required>
    ...
    <div class="row ">
        ...
        <div class="col-6 form-floating input-group  mb-4" style="float: right">
            ...
            <button type="button" class="btn btn-outline-primary"
                onmousedown="$('#password-confirm').attr('type','text');"
                onmouseup="$('#password-confirm').attr('type','password');"> <i class="bi bi-eye-slash"></i></button>
        </div>
