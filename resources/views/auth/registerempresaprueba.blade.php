<form class="text-start mb-3" method="POST" enctype="multipart/form-data" action="{{ route('register_post_prueba') }}">
    @csrf
    ...
    <div class="row">
        <div class="col-6 form-floating mb-4">
            <input id="empresanombre" type="text" class="form-control" name="empresanombre" value="Usuario de Prueba"
            disabled readonly>
