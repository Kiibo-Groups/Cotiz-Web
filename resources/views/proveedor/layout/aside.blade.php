    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        @if (auth()->user()->status == 0)
            ...
            <li class="nav-item">
                ...
                <ul id="catalogo-nav" class="nav-content  collapse @if(Route::is('catalogo_create_post') ||Route::is('catalogo_edit') || Route::is('catalogo_ver') || Route::is('catalogo') || Route::is('catalogo.show'))  show @endif" data-bs-parent="#catalogo-nav">
                  <li>
