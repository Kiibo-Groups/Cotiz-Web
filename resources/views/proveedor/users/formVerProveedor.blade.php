                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <a target="_blank" class="btn btn-warning"
                                                ...
                                                href="{{ url(env('user') . '/empresas/gafete/' . $data->fotoGafete) }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <a target="_blank" class="btn btn-warning"
                                                ...
                                                href="{{ url(env('user') . '/empresas/gafete/' . $data->fotoGafete2) }}">
                                                <i class="bi bi-download"></i>
                                            </a>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <a target="_blank" class="btn btn-warning"
                                                ...
                                                href="{{ url(env('user') . '/empresas/credencial/' . $data->fotoCredencial) }}">
                                                <i class="bi bi-download"></i>
                                            </a>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <a target="_blank" class="btn btn-warning"
                                                ...
                                                href="{{ url(env('user') . '/empresas/credencial/' . $data->fotoCredencial2) }}">
                                                <i class="bi bi-download"></i>
                                            </a>
