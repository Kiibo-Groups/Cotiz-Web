                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-md-6">
                                            ...
                                            <a target="_blank" class="btn btn-warning"
                                                ...
                                                href="{{ url(env('user') . '/empresas/gafete/' . $data->id) }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <a target="_blank" class="btn btn-warning"
                                                ...
                                                href="{{ url(env('user') . '/empresas/gafete2/' . $data->id) }}">
                                                <i class="bi bi-download"></i>
                                            </a>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <a target="_blank" class="btn btn-warning"
                                                ...
                                                href="{{ url(env('user') . '/empresas/credencial/' . $data->id) }}">
                                                <i class="bi bi-download"></i>
                                            </a>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <a target="_blank" class="btn btn-warning"
                                                ...
                                                href="{{ url(env('user') . '/empresas/credencial2/' . $data->id) }}">
                                                <i class="bi bi-download"></i>
                                            </a>
