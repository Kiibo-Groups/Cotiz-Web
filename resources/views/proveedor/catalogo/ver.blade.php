                                                ...
                                                @foreach ($certificado as $key => $req)
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center" class="col-md-1">
                                                            ...
                                                            href="{{ url(env('user') . '/catalogo/certificados/file/' . $req->id) }}">
                        ...
                        <div class="row" style="margin-right:1px;margin-top:18px;">
                            <div class="col-md-4">
                                ...
                                <a target="_blank" class="btn btn-warning"
                                    ...
                                    href="{{ url(env('user') . '/catalogo/file/' . $data->id) }}">
                                    <i class="bi bi-download"></i>
                                </a>
                            ...
                            <div class="col-md-4">
                                ...
                                <a target="_blank" class="btn btn-warning"
                                    ...
                                    href="{{ url(env('user') . '/catalogo/file2/' . $data->id) }}">
                                    <i class="bi bi-download"></i>
                                </a>
                            ...
                            <div class="col-md-4">
                                ...
                                <a target="_blank" class="btn btn-warning"
                                    ...
                                    href="{{ url(env('user') . '/catalogo/file3/' . $data->id) }}">
                                    <i class="bi bi-download"></i>
                                </a>
                    ...
                    <div class="row" style="margin-right:1px;margin-top:18px;">
                        <div class="col-md-4">
                            ...
                            <a target="_blank" class="btn btn-warning"
                                ...
                                href="{{ url(env('user') . '/catalogo/fil4/' . $data->id) }}">
                                <i class="bi bi-download"></i>
                            </a>
                        ...
                        <div class="col-md-4">
                            ...
                            <a target="_blank" class="btn btn-warning" title="Descargar CV actualizado a color"
                                href="{{ url(env('user') . '/catalogo/file5/' . $data->id) }}">
                                <i class="bi bi-download"></i>
                            </a>
                        ...
                        <div class="col-md-4">
                            ...
                            <a target="_blank" class="btn btn-warning"
                                ...
                                href="{{ url(env('user') . '/catalogo/file6/' . $data->id) }}">
                                <i class="bi bi-download"></i>
                            </a>
                    ...
                    <div class="row" style="margin-right:1px;margin-top:18px;">
                        <div class="col-md-4">
                            ...
                            <a target="_blank" class="btn btn-warning"
                                ...
                                href="{{ url(env('user') . '/catalogo/file7/' . $data->id) }}">
                                <i class="bi bi-download"></i>
                            </a>
                        ...
                        <div class="col-md-4">
                            ...
                            <a target="_blank" class="btn btn-warning"
                                ...
                                href="{{ url(env('user') . '/catalogo/file8/' . $data->id) }}">
                                <i class="bi bi-download"></i>
                            </a>
