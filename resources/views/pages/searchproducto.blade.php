<div class="grid lg:grid-cols-12 lg:gap-6">
    <div class="lg:col-span-6 mb-5">
        <div class="ltr:text-left rtl:text-right">
            <label for="name" class="font-semibold">Nombre del producto / dispositivo</label>
    ...
    <div class="lg:col-span-6 mb-5">
        <div class="ltr:text-left rtl:text-right">
            <label for="email" class="font-semibold">Modelo</label>
            <div class="form-icon relative mt-2">
...
<div class="grid lg:grid-cols-12 lg:gap-6">
    ...
    <div class="lg:col-span-6 mb-5">
        <div class="ltr:text-left rtl:text-right">
            <label for="email" class="font-semibold">Cantidad</label>
            <div class="form-icon relative mt-2">
                <i data-feather="cantidad" class="w-4 h-4 absolute top-3 ltr:left-4 rtl:right-4"></i>
                <input name="cantidad" id="cantidad" type="number" class="form-input ltr:pl-11 rtl:pr-11" required>
            </div>
        </div>
    </div>
</div>
...
<div class="grid grid-cols-1">
    <div class="mb-5">
        <div class="ltr:text-left rtl:text-right">
            <label for="description" class="font-semibold">Descripción especifica del producto /
                dispositivo - Datos extras para ayudar a cotización</label>
            <div class="form-icon relative mt-2">
