    ...
    <section class="md:h-screen py-36 h-auto relative flex items-center background-effect overflow-hidden"
        ...
        <div class="container z-1">
            ...
            @if (Auth::user())
                ...
                <div class="grid grid-cols-1 mt-10">
                    <h4 class="lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5 font-bold">Encuentra los mejores <br>
                                        ...
                                        <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:gap-0 gap-6">
                                            <div class="filter-search-form relative filter-border">
                                                <input name="q" type="text" id="job-keyword"
                                                    ...
                                                    placeholder="Busca tus productos y/o servicios" style="padding-left: 25px;">
                                            </div>

                                            <div class="filter-search-form relative filter-border">
                                                <select class="form-select" name="type" data-trigger id="choices-location"
        ...
        <ul class="circles p-0 mb-0">
            <li class="brand-img"><img src="{{ asset('assets2/images/client/shree-logo.png') }}" class="w-9 h-9"
                    alt=""></li>
            <li class="brand-img"><img src="{{ asset('assets2/images/client/skype.png') }}" class="w-9 h-9" alt="">
            </li>
                ...
                <div class="container">
                    <div class="grid md:grid-cols-12 grid-cols-1 pb-8 items-end">
                        <div class="lg:col-span-8 md:col-span-6 text-left">
                            <h3 class="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">Busca por
                                categorias</h3>
                        ...
                        <div class="tiny-five-item">
                            <div class="tiny-slide">
                                <div
                                    ...
                                    <div class="content mt-6">
                                        <a href="{{ url('/search/?type=product') }}"
                                            class="title h5 text-lg font-medium hover:text-indigo-600">Productos</a>
                            ...
                            <div class="tiny-slide">
                                <div
                                    ...
                                    <div class="content mt-6">
                                        <a href="{{ url('/search/?type=service') }}"
                                            class="title h5 text-lg font-medium hover:text-indigo-600">Servicios</a>
                            ...
                            <div class="tiny-slide">
                                <div
                                    ...
                                    <div class="content mt-6">
                                        <a href="{{ url('/search/?type=employe') }}"
                                            class="title h5 text-lg font-medium hover:text-indigo-600">Pesonal</a>
            ...
            <section class="relative">
                <div class="container">
                    <div class="grid grid-cols-1 pb-8 text-left">
                        <h3 class="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">Ultimos
                            elementos</h3>
                        ...
                        @if (count($allProducts) > 0)
                            @foreach ($allProducts as $item)
                                <div class="rounded-md shadow dark:shadow-gray-800">
                                    <div class="p-6">
                                        <a href="{{ asset('viewprod/' . base64_encode(urldecode($item->id)) . '/' . $item->title) }}"
                                            class="title h5 text-lg font-semibold hover:text-indigo-600">{{ $item->title }}</a>
                                        <p class="text-slate-400 mt-2"><i class="uil uil-clock text-indigo-600"></i>
                                            {{ $item->created_at->diffForHumans() }}</p>

                                        <div class="flex justify-between items-center mt-4">
                                            <span
                                                class="bg-indigo-600/5 text-indigo-600 text-xs font-bold px-2.5 py-0.5 rounded h-5">{{ $item->type }}</span>

                                            <p class="text-slate-400"><i class="uil uil-usd-circle text-indigo-600"></i>
                                                ${{ number_format($item->price, 2) }}</p>
                                        </div>
                                    </div>

                                    <div class="flex items-center p-6 border-t border-gray-100 dark:border-gray-700">
                                        <img src="{{ asset('assets/img/logos/' . $item->provider->logo) }}"
