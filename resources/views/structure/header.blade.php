...
<header class="wrapper @if(Route::is('home')) bg-dark @else bg-soft-primary @endif">
    <nav class="navbar navbar-expand-lg center-nav transparent @if(Route::is('home')) navbar-dark @elseif(Route::is('login') || Route::is('register'))  position-absolute @else navbar-light @endif">
      <div class="container flex-lg-row flex-nowrap align-items-center">
        ...
        <div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
          <div class="offcanvas-header d-lg-none">
            <h3 class="text-white fs-30 mb-0">Engine</h3>
