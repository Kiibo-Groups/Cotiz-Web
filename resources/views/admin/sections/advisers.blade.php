...
@section('title') Sección asesores @endsection
@section('page_active') asesores @endsection 
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title">
                        <h2>Editando Sección asesores</h2>
                    </div> 
                                        ...
                                        <div class="ec-vendor-main-img">
                                            <div class="avatar-upload">
                                                <div class="avatar-edit">    
                                                    <label class="form-label">1120px * 570px</label>                                                       
                                ...
                                <div class="col-lg-6">
                                    <div class="ec-vendor-img-upload">
                                        <div class="ec-vendor-main-img">
                                            <div class="avatar-upload">
                                                <div class="avatar-edit">       
                                                    <label class="form-label">293px * 260px</label>                                                       
