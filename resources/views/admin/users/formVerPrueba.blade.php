                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <a target="_blank" class="btn btn-warning"
                                                ...
                                                href="{{ url(env('admin') . '/empresas/gafete/' . $data->id) }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <a target="_blank" class="btn btn-warning"
                                                ...
                                                href="{{ url(env('admin') . '/empresas/gafete2/' . $data->id) }}">
                                                <i class="bi bi-download"></i>
                                            </a>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <a target="_blank" class="btn btn-warning"
                                                ...
                                                href="{{ url(env('admin') . '/empresas/credencial/' . $data->id) }}">
                                                <i class="bi bi-download"></i>
                                            </a>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <a target="_blank" class="btn btn-warning"
                                                ...
                                                href="{{ url(env('admin') . '/empresas/credencial2/' . $data->id) }}">
                                                <i class="bi bi-download"></i>
                                            </a>
