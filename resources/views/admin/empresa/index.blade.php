                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $req->colonia }}</td>
                                    <td class="col-md-1" style="text-align: right">{{ number_format($req->cashback )}}</td>
                                    ...
                                    <td class="col-md-1">
                                        <div class="btn-group mb-1">
                                            ...
                                            <div class="dropdown-menu">
												...
												<a class="dropdown-item" href="{{ url(env('admin').'/empresas/usuarios/cashback/'.$req->id) }}">CashBack</a>
