                                            ...
                                            <tr>
                                                ...
                                                <td class="col-md-1">
                                                    <div class="btn-group mb-1">
                                                        <button type="button"
                                                            class="btn btn-outline-success sm-btn dropdown-toggle dropdown-toggle-split"
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item"
                                                                href="{{ url(env('admin') . '/empresas/ver/' . $req->id) }}">Ver</a>
                                                            <a class="dropdown-item"
                                                                href="{{ url(env('admin') . '/empresas/status/' . $req->id) }}">Activar/Desactivar</a>
                                                            <a class="dropdown-item"
                                                                href="{{ url(env('admin') . '/empresas/usuarios/ver/' . $req->id) }}">Ver
                                                                Usuários</a>
                                                            <a class="dropdown-item"
                                                                href="{{ url(env('admin') . '/empresas/usuarios/cashback/' . $req->id) }}">CashBack</a>
