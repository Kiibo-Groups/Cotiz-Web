                            ...
                            <div class="col-12 col-sm-4 p-3">
                                <div class="card">
                                    <div class="card-img-box">
                                            <div style="background-image:url('{{ asset('public/assets/img/logos/'.$service->logo) }}');background-size: cover;width: 100%;height: 210px;background-position: center center;"></div>
                                    </div>
