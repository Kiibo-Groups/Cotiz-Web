				...
				<div class="container">
						...
						@foreach($providers as $provider)
								<div class="group rounded-md bg-white dark:bg-slate-900 shadow hover:shadow-xl dark:hover:shadow-xl dark:shadow-gray-800 dark:hover:shadow-gray-700 overflow-hidden ease-in-out duration-500">
										<div class="relative">
											@if($provider->logo) 
												<img src="<?php echo asset('assets/img/logos/'.$provider->logo) ?>" alt="">
											@else
										...
										<div class="p-6">
												...
												<ul class="py-2 border-y border-gray-100 dark:border-gray-800 flex items-center list-none">
													<li>
															...
															<p class="text-lg font-medium">{{ $provider->address}}</p>
														</li>
												</ul>
												...
												<ul class="py-2 flex justify-between items-center list-none">
														<li>
																...
																<p class="text-lg font-medium">{{ $provider->email}}</p>
														</li>
														<li>
																<span class="text-slate-400">Pais</span>
																<p class="text-lg font-medium">{{ $provider->country}}</p>
														</li>
												...
												<ul>
													<li>
															...
															<p class="text-lg font-medium">{{ $provider->phone}}</p>
													</li>
												</ul>
												<ul class="py-2 border-y border-gray-100 justify-between dark:border-gray-800 flex items-center justify-space-ber list-none">
														<li>
															<a href="{{ url(env('admin').'/providers/edit/'.$provider->id) }}" class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white searchbtn submit-btn w-full !h-12 rounded">
															Editar	
														</a>
														</li>
														<li>
															<a href="{{ url(env('admin').'/providers/delete/'.$provider->id) }}" class="btn bg-red-600 hover:bg-red-700 border-red-600 hover:border-red-700 text-white searchbtn submit-btn w-full !h-12 rounded">
															Eliminar	
														</a>
														</li>
												</ul>
